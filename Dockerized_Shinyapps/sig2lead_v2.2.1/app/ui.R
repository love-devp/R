...
############# Add this ##############################################     
                 br(),
                  ...
                  tags$h1("Sig2Lead ranks potential inhibitors as illustrated below of a target gene by employing transcriptional signature connectivity and chemical similarity analysis"),
                  br(),
                  br(),
                     #fluidRow(
                     #column(3, 
    ...
    tags$div(class='tlp',
             ...
             tags$div(class="tooltip_text",
                      tags$h3(id = "hover1", "For a set of candidate molecules defined in a user 
                                              ...
                                              analog to a GOF signature indicates21 an agonist.",
                              tags$a(href="https://lincsproject.org/", "LINCS")
                      )
...
tabPanel("Help",
         mainPanel(
           ...
           includeHTML("./www/Sig2Lead_Version_2.2_User_Manual.htm")
         )
)

...
library("cluster")
library("ggplot2")
source("/srv/shiny-server/lib/minsim_function.R", local=TRUE)
source("/srv/shiny-server/lib/minsim_function_sim_search.R", local=TRUE)
source("/srv/shiny-server/lib/fpsim_function.R", local=TRUE)
source("/srv/shiny-server/lib/fpsim_function_sim_search.R", local=TRUE)
...
bypass_clustering_fpsim <- function(sdfset_add, lsm_rows)
{
  test_fpsim <- fpsim(sdfset_add, lsm_rows)
  return(test_fpsim)
}

bypass_clustering_minsim <- function(sdfset_add,lsm_rows, max_cons_4)
{
 test_minsim <- minsim(sdfset_add,lsm_rows) 
 return(test_minsim)
}

bypass_clustering_minsim_sim_search <- function(sdfset_add,lsm_rows,topNum)
{
  test_minsim <- minsim_sim_search(sdfset_add,lsm_rows,topNum) 
  return(test_minsim)
}

bypass_clustering_fpsim_sim_search <- function(sdfset_add, lsm_rows, topNum)
{
  test_fpsim <- fpsim_sim_search(sdfset_add, lsm_rows, topNum)
  return(test_fpsim)
}
